...
// IsTransientControllerError reports whether a control-dispatcher error is
// likely caused by temporary storage or connection pressure and should be retried.
